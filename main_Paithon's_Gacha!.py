...
# ---------Defining Functions----------
# Data saving function for cleaner code
def save_data():
    with open("inventory.json", "w") as F:
        # noinspection PyTypeChecker
...
def instructions():
    ...
    print(" o \033[91mHard\033[0m gives \033[95m\"190 Primogems\"\033[0m per question")
    ...
    input(
        " o The 9 other wishes from one pull are random; usually a 3-star, as higher value items have lower drop rates!\n ")
        ...
        if wChoice == "yes":
            if data[0]['primogems'] >= 1600:
                ...
                # 50-50 BETWEEN LIMITED OR PERMANENT 5-STAR
                 ...
                 # If the player's Primogems aren't enough to wish
                 else:
                     print("\n"
                           "You don't have enough Primogems... (¬_¬＂)")
